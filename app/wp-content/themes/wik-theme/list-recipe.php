        ...
        <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
            ...
            <div class="recipe-row">
                ...
                <div class="is-flex-container recipes-buttons">
                    <a href="<?= get_site_url() ?>/edition-de-recette?id=<?php the_ID() ?>" class="icon-link button">
                    ...
                    <a href="<?= admin_url('admin-post.php') ?>?action=wik_delete_recipe&recipe_id=<?= the_ID() ?>&return_to=<?= home_url($wp->request) ?>" class="icon-link button">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 700 700">
